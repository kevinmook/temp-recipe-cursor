...
var MenuContext = require('../MenuContext-45622aab.js');
...
var DialogBackdropContext = require('../DialogBackdropContext-9ef1477c.js');
...
function useFocusTrap(dialogRef, visibleModals, options) {
  ...
  React.useEffect(function () {
    ...
    var handleClick = function handleClick() {
      ...
      if (!hasFocusWithin.hasFocusWithin(portal)) {
        dialog.focus();
      }
    };
...
function isDisclosure(target) {
  return function (disclosure) {
    ...
    if (contains.contains(disclosure, target)) return true;
...
function useEventListenerOutside(containerRef, disclosuresRef, nestedDialogs, eventType, listener, shouldListen) {
  ...
  React.useEffect(function () {
    ...
    var handleEvent = function handleEvent(event) {
      ...
      if (contains.contains(container, target)) return; // Click on disclosure
...
function useHideOnClickOutside(dialogRef, disclosuresRef, nestedDialogs, options) {
  ...
  useEventListenerOutside(dialogRef, disclosuresRef, nestedDialogs, "focus", function (event) {
    ...
    if (event.target !== getDocument.getDocument(dialogRef.current)) {
      var _options$hide2;
...
var useDialog = createHook.createHook({
  name: "Dialog",
  compose: DisclosureContent.useDisclosureContent,
  ...
  useOptions: function useOptions(_ref) {
    var _ref$modal = _ref.modal,
        ...
        options = _rollupPluginBabelHelpers._objectWithoutPropertiesLoose(_ref, ["modal", "hideOnEsc", "hideOnClickOutside", "preventBodyScroll", "unstable_autoFocusOnShow", "unstable_autoFocusOnHide", "unstable_orphan", "unstable_modal", "setModal"]);

    React.useEffect(function () {
      if (setModal && unstable_modal !== modal) {
        process.env.NODE_ENV !== "production" ? reakitWarning.warning(true, "Setting `modal` prop on `Dialog` is deprecated. Set it on `useDialogState` instead.", "See https://github.com/reakit/reakit/pull/535") : void 0;
        setModal(modal);
      }
  ...
  useProps: function useProps(options, _ref2) {
    var htmlRef = _ref2.ref,
        ...
        htmlProps = _rollupPluginBabelHelpers._objectWithoutPropertiesLoose(_ref2, ["ref", "onKeyDown", "wrapElement"]);
    ...
    var wrapElement = React.useCallback(function (element) {
      ...
      if (options.modal && !hasBackdrop) {
        element = /*#__PURE__*/React.createElement(Portal.Portal, null, element);
      }
