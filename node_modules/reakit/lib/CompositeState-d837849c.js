...
function verticalizeItems(items) {
  ...
  for (var i = 0; i < maxLength; i += 1) {
    for (var _iterator = _rollupPluginBabelHelpers._createForOfIteratorHelperLoose(groups), _step; !(_step = _iterator()).done;) {
      ...
      if (group[i]) {
        verticalized.push(_rollupPluginBabelHelpers._objectSpread2({}, group[i], {
...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case "registerItem":
      {
        ...
        var nextState = _rollupPluginBabelHelpers._objectSpread2({}, state, {
          items: addItemAtIndex(items, nextItem, _index)
        });

        return _rollupPluginBabelHelpers._objectSpread2({}, nextState, {
    ...
    case "unregisterItem":
      {
        ...
        var _nextState = _rollupPluginBabelHelpers._objectSpread2({}, state, {
          pastIds: nextPastIds,
          items: nextItems
        ...
        if (currentId && currentId === _id2) {
          var nextId = getCurrentId(_rollupPluginBabelHelpers._objectSpread2({}, _nextState, {
            currentId: nextPastIds[0]
          }));
          return _rollupPluginBabelHelpers._objectSpread2({}, _nextState, {
            currentId: nextId
          });
        }
    ...
    case "next":
      {
        ...
        if (currentId == null) {
          return reducer(state, _rollupPluginBabelHelpers._objectSpread2({}, action, {
            type: "first"
          }));
    ...
    case "previous":
      {
        ...
        var _nextState2 = reducer(_rollupPluginBabelHelpers._objectSpread2({}, state, {
          items: reverse(items)
        }), _rollupPluginBabelHelpers._objectSpread2({}, action, {
          type: "next",
          hasNullItem: _hasNullItem
        }));

        return _rollupPluginBabelHelpers._objectSpread2({}, _nextState2, {
          items: items
        });
      }
    ...
    case "down":
      {
        ...
        var _nextState3 = reducer(_rollupPluginBabelHelpers._objectSpread2({}, state, {
        ...
        return _rollupPluginBabelHelpers._objectSpread2({}, _nextState3, {
    ...
    case "up":
      {
        ...
        var _nextState4 = reducer(_rollupPluginBabelHelpers._objectSpread2({}, state, {
          orientation: "vertical",
        ...
        return _rollupPluginBabelHelpers._objectSpread2({}, _nextState4, {
          orientation: orientation,
          items: items
        });
      }
    ...
    case "last":
      {
        var _nextState5 = reducer(_rollupPluginBabelHelpers._objectSpread2({}, state, {
          items: reverse(items)
        }), _rollupPluginBabelHelpers._objectSpread2({}, action, {
          type: "first"
        }));

        return _rollupPluginBabelHelpers._objectSpread2({}, _nextState5, {
          items: items
        });
      }
    ...
    case "setCurrentId":
      {
        var nextCurrentId = getCurrentId(_rollupPluginBabelHelpers._objectSpread2({}, state, {
...
function unstable_useCompositeState(initialState) {
  ...
  var _useSealedState = useSealedState.useSealedState(initialState),
      ...
      sealed = _rollupPluginBabelHelpers._objectWithoutPropertiesLoose(_useSealedState, ["unstable_virtual", "rtl", "orientation", "currentId", "loop", "wrap"]);
  ...
  var _React$useReducer = React.useReducer(reducer, {
    ...
    initialWrap: wrap
      ...
      state = _rollupPluginBabelHelpers._objectWithoutPropertiesLoose(_React$useReducer$, ["pastIds", "initialVirtual", "initialRTL", "initialOrientation", "initialCurrentId", "initialLoop", "initialWrap"]),
...
exports.unstable_useCompositeState = unstable_useCompositeState;
