...
function useToolbarState(initialState) {
  ...
  return CompositeState.unstable_useCompositeState(_rollupPluginBabelHelpers._objectSpread2({
    orientation: orientation
  }, sealed));
}
var keys = [].concat(CompositeState.unstable_useCompositeState.__keys);
