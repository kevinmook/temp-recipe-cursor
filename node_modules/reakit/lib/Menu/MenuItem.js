...
function hoveringAnotherMenuItem(event, items) {
  ...
  return items === null || items === void 0 ? void 0 : items.some(function (item) {
    return item.ref.current === nextElement;
  });
}
...
var useMenuItem = createHook.createHook({
  ...
  useProps: function useProps(options, _ref) {
    ...
    var onMouseLeave = React.useCallback(function (event) {
      ...
      if (hoveringExpandedMenu(event, menu === null || menu === void 0 ? void 0 : menu.children)) return; // On menu bars, hovering out of disclosure doesn't blur it.

      if ((menu === null || menu === void 0 ? void 0 : menu.role) === "menubar" && isExpandedDisclosure(self)) return; // Move focus to menu after blurring
