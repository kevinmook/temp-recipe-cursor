...
var unstable_useComposite = createHook.createHook({
  name: "Composite",
...
var unstable_Composite = createComponent.createComponent({
  as: "div",
  useHook: unstable_useComposite,
  useCreateElement: function useCreateElement$1(type, props, children) {
    process.env.NODE_ENV !== "production" ? reakitWarning.useWarning(validCompositeRoles.indexOf(props.role) === -1, "You should provide a valid `role` attribute to composite components.", "See https://reakit.io/docs/composite") : void 0;
...
exports.unstable_Composite = unstable_Composite;
exports.unstable_useComposite = unstable_useComposite;
