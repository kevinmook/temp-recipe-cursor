...
var setTextFieldValue = require('../setTextFieldValue-fc0d2717.js');
...
var unstable_useCompositeItem = createHook.createHook({
  name: "CompositeItem",
  compose: [Clickable.useClickable, Id.unstable_useId],
  ...
  useProps: function useProps(options, _ref) {
    var htmlRef = _ref.ref,
        ...
        htmlProps = _rollupPluginBabelHelpers._objectWithoutPropertiesLoose(_ref, ["ref", "tabIndex", "onFocus", "onBlur", "onKeyDown", "onClick"]);
    ...
    !options.items;
    process.env.NODE_ENV !== "production" ? reakitWarning.useWarning(!!options.stopId, "The `stopId` prop has been deprecated. Please, use the `id` prop instead.", ref) : void 0;
    ...
    var onFocus = React.useCallback(function (event) {
      ...
      if (isSelfTarget.isSelfTarget(event) && options.unstable_virtual && options.baseId) {
    ...
    var onCharacterKeyDown = React.useCallback(function (event) {
      ...
      if (event.key.length === 1 && event.key !== " ") {
        ...
        if (widget && isTextField.isTextField(widget)) {
          ...
          window.requestAnimationFrame(function () {
            setTextFieldValue.setTextFieldValue(widget, key);
          });
        }
      }
    }, []);
    var onKeyDown = React.useMemo(function () {
      return createOnKeyDown.createOnKeyDown({
        ...
        shouldKeyDown: isSelfTarget.isSelfTarget,
    ...
    var onClick = React.useCallback(function (event) {
      ...
      if (widget && !hasFocusWithin.hasFocusWithin(widget)) {
        ...
        widget.focus();
      } else if (isSelfTarget.isSelfTarget(event) && !hasFocusWithin.hasFocusWithin(event.currentTarget)) {
...
var unstable_CompositeItem = createComponent.createComponent({
  as: "button",
  memo: true,
  useHook: unstable_useCompositeItem
});

exports.unstable_CompositeItem = unstable_CompositeItem;
exports.unstable_useCompositeItem = unstable_useCompositeItem;
