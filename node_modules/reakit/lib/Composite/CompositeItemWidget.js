    ...
    var onKeyDown = React.useCallback(function (event) {
      ...
      if (event.key === "Enter") {
        if (isTextField.isTextField(self)) {
          var isMultilineTextField = self.tagName === "TEXTAREA"; // Make sure we can create new lines using Shift+Enter
