...
function useTabState(initialState) {
  ...
  var composite = unstable_useCompositeState(_objectSpread2({
    loop: loop,
    currentId: initialSelectedId
  }, sealed));
  var panels = unstable_useCompositeState();
  ...
  return _objectSpread2({}, composite, {
...
var keys = [].concat(unstable_useCompositeState.__keys, ["selectedId", "panels", "manual", "select", "setSelectedId", "registerPanel", "unregisterPanel"]);
