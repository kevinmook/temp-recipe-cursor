...
var useTabPanel = createHook({
  ...
  useProps: function useProps(options, _ref) {
    ...
    process.env.NODE_ENV !== "production" ? useWarning(Boolean(options.stopId), "`TabPanel`'s `stopId` prop is deprecated. Use `tabId` instead.", "See https://reakit.io/docs/tab", ref) : void 0;
    useEffect(function () {
