...
export declare type DialogOptions = DisclosureContentOptions & Pick<Partial<DialogStateReturn>, "modal" | "setModal" | "unstable_modal" | "hide"> & Pick<DialogStateReturn, "baseId"> & {
    /**
...
export declare const useDialog: {
    (options?: DialogOptions | undefined, htmlProps?: import("..").BoxHTMLProps | undefined, unstable_ignoreUseOptions?: boolean | undefined): import("..").BoxHTMLProps;
    __keys: readonly any[];
